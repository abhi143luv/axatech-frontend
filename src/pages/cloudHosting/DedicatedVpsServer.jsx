...
export default function DedicatedVpsServer() {
  ...
  return (
    <>
      <PageMeta
        title={content.metaTitle || 'Dedicated VPS Server | Axatech'}
        description={content.metaDescription || 'Dedicated VPS server plans for Tally with full control, custom resources and enterprise-grade uptime.'}
      ...
      <section className="bg-linear-to-b from-slate-50 to-white pb-20 md:pb-24 dark:from-gray-900 dark:to-gray-900/90">
        <div className="hero-gradient-section py-20 md:py-24">
          <div className="mx-auto max-w-4xl px-5">
            <SectionHeader
              label={content.label || '3.2 Dedicated VPS Server'}
              title={content.title || 'Dedicated Performance for Growing Businesses'}
              subtitle={
                content.subtitle ||
        ...
        <div className="mx-auto mt-10 max-w-5xl px-5">
          ...
          <div className="mt-8">
            <Button
              ...
              className="px-6"
            >
              {content.ctaText || 'Request Dedicated VPS'}
            </Button>
          </div>
        </div>
      </section>
