...
export default function IntegrationThirdParty() {
  ...
  useEffect(() => {
    api.integrationThirdPartyContent
      .get()
      .then(setContent)
      .catch(console.error);
  }, []);
  ...
  return (
    <>
      <PageMeta
        title={content.metaTitle || 'Third-Party Application Integration | Axatech'}
        description={
          content.metaDescription ||
          'Connect Tally with ERP, CRM and e-commerce systems using API, XML, JSON and ODBC.'
        }
      ...
      <section className="bg-linear-to-b from-slate-50 to-white pb-20 md:pb-24 dark:from-gray-900 dark:to-gray-900/90">
        <div className="hero-gradient-section py-20 md:py-24">
          ...
          <SectionHeader
            label={content.label || '6.2 Third-Party Application Integration'}
            title={content.title || 'Connect Tally with Your Business Software'}
            subtitle={
              content.subtitle ||
        ...
        <div className="mx-auto mt-10 max-w-5xl px-5">
          ...
          <div className="mt-8">
            <Button
              ...
              className="px-6"
            >
              {content.ctaText || 'Request Integration'}
            </Button>
          </div>
        </div>
      </section>
